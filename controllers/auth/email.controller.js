...
const resendEmailVerificationExistingUser = asyncHandler(
  /**
   * @param {import("express").Request} req
   * @param {import("express").Response} res
   */
  ...
  async (req, res) => {
    const user = await model.UserModel.findOne({ _id: req.user._id });
...
const resendEmailVerificationNewUser = asyncHandler(
  /**
   * @param {import("express").Request} req
   * @param {import("express").Response} res
   */
...
module.exports = {
  emailVerification,
  forgotPassword,
  resendEmailVerificationExistingUser,
  resendEmailVerificationNewUser,
};
